...
/**
 * Class for component which allows to declare C3.js chart of type Donut in facelet.
 *
 * It does not return any default properties to component.
 *
 * @author Martin Linha
 */
@FacesComponent("org.kivio.c3faces.component.Donut")
public class Donut extends C3Chart {
