...
/**
 * Class for component which allows to declare C3.js chart of type Gauge in facelet.
 *
 * It does not return any default properties to component.
 *
 * @author Martin Linha
 */
@FacesComponent("org.kivio.c3faces.component.Gauge")
public class Gauge extends C3Chart {
